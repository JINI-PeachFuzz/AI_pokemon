...
public class CommentValidator implements Validator, PasswordValidator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        /***
         * 1. 수정모드인 경우 seq 필수
         * 2. 비회원인 경우 questPw 필수, 비밀번호 복잡성 - 대소문자 구분없는 알파벳 + 숫자
         */
        ...
        if (!memberUtil.isLogin()) {
            ...
            if (StringUtils.hasText(questPw) && (!alphaCheck(questPw, true) || !numberCheck(questPw))) {
                errors.rejectValue("questPw", "Complexity");
            }
        }
    }
}
